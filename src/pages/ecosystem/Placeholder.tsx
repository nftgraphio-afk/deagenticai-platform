...
export function ComingSoon({ name, activeStep }: { name: string, activeStep?: string }) {
  return (
    <div className="min-h-screen bg-black flex flex-col items-center justify-center p-6 pt-32">
      {activeStep && (
        <div className="w-full max-w-7xl mb-16">
          <HexDock activeStep={activeStep} className="py-0" />
        </div>
      )}
